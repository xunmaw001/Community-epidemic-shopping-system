    ...
    <div>
        <div class="container">
            <div class="login-form">
                <h1 class="h1" style="color:#000;fontSize:28px;">小区疫情购物系统注册</h1>
                <el-form class="rgs-form">
                    ...
                    <el-form-item label="重复密码" class="input">
                        ...
                        <el-form-item label="配送人员姓名" class="input" v-if="tableName=='peisongrenyuan'">
                            <el-input v-model="ruleForm.peisongrenyuanName" autocomplete="off" placeholder="配送人员姓名"  />
                        </el-form-item>
                        <el-form-item label="配送人员手机号" class="input" v-if="tableName=='peisongrenyuan'">
                            <el-input v-model="ruleForm.peisongrenyuanPhone" autocomplete="off" placeholder="配送人员手机号"  />
                        </el-form-item>
                        <el-form-item label="配送人员身份证号" class="input" v-if="tableName=='peisongrenyuan'">
                            <el-input v-model="ruleForm.peisongrenyuanIdNumber" autocomplete="off" placeholder="配送人员身份证号"  />
                        </el-form-item>
                        <el-form-item label="电子邮箱" class="input" v-if="tableName=='peisongrenyuan'">
                            <el-input v-model="ruleForm.peisongrenyuanEmail" autocomplete="off" placeholder="电子邮箱"  />
                        </el-form-item>
    ...
    export default {
        ...
        methods: {
            ...
            login() {
                            ...
                            if((!this.ruleForm.peisongrenyuanName)&& 'peisongrenyuan'==this.tableName){
                                this.$message.error('配送人员姓名不能为空');
                                return
                            }
                             if('peisongrenyuan' == this.tableName && this.ruleForm.peisongrenyuanPhone&&(!this.$validate.isMobile(this.ruleForm.peisongrenyuanPhone))){
                                 this.$message.error('手机应输入手机格式');
                                 return
                             }
                            if((!this.ruleForm.peisongrenyuanIdNumber)&& 'peisongrenyuan'==this.tableName){
                                this.$message.error('配送人员身份证号不能为空');
                                return
                            }
                            if('peisongrenyuan' == this.tableName && this.ruleForm.peisongrenyuanEmail&&(!this.$validate.isEmail(this.ruleForm.peisongrenyuanEmail))){
...
<style lang="scss" scoped>
	...
	.container {
        ...
        background-image: url(/xiaoquyiqingguanlixitong/img/back-img-bg.jpg);
