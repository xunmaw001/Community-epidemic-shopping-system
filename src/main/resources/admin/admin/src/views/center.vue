<template>
  <div>
    ...
    >  
     <el-row>
                    <el-col :span="12">
           <el-form-item v-if="flag=='peisongrenyuan'"  label='配送人员姓名' prop="peisongrenyuanName">
               <el-input v-model="ruleForm.peisongrenyuanName"  placeholder='配送人员姓名' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="12">
           <el-form-item v-if="flag=='peisongrenyuan'"  label='配送人员手机号' prop="peisongrenyuanPhone">
               <el-input v-model="ruleForm.peisongrenyuanPhone"  placeholder='配送人员手机号' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="12">
           <el-form-item v-if="flag=='peisongrenyuan'"  label='配送人员身份证号' prop="peisongrenyuanIdNumber">
               <el-input v-model="ruleForm.peisongrenyuanIdNumber"  placeholder='配送人员身份证号' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="12">
             <el-form-item v-if="flag=='peisongrenyuan'" label='配送人员头像' prop="peisongrenyuanPhoto">
                 <file-upload
                         tip="点击上传照片"
                         action="file/upload"
                         :limit="3"
         ...
         <el-col :span="12">
           <el-form-item v-if="flag=='peisongrenyuan'"  label='电子邮箱' prop="peisongrenyuanEmail">
               <el-input v-model="ruleForm.peisongrenyuanEmail"  placeholder='电子邮箱' clearable></el-input>
           </el-form-item>
         </el-col>
...
// 注册表 商家 的级联表
  ...
  methods: {
    ...
    onUpdateHandler() {
                         if((!this.ruleForm.peisongrenyuanName)&& 'peisongrenyuan'==this.flag){
                             this.$message.error('配送人员姓名不能为空');
                             return
                         }

                             if( 'peisongrenyuan' ==this.flag && this.ruleForm.peisongrenyuanPhone&&(!isMobile(this.ruleForm.peisongrenyuanPhone))){
                                 this.$message.error(`手机应输入手机格式`);
                                 return
                             }
                         if((!this.ruleForm.peisongrenyuanIdNumber)&& 'peisongrenyuan'==this.flag){
                             this.$message.error('配送人员身份证号不能为空');
                             return
                         }

                         if((!this.ruleForm.peisongrenyuanPhoto)&& 'peisongrenyuan'==this.flag){
                             this.$message.error('配送人员头像不能为空');
                             return
                         }

                             if( 'peisongrenyuan' ==this.flag && this.ruleForm.peisongrenyuanEmail&&(!isEmail(this.ruleForm.peisongrenyuanEmail))){
