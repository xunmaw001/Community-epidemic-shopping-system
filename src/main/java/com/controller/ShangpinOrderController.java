    ...
    */
    ...
    public R info(@PathVariable("id") Long id, HttpServletRequest request){
        ...
        if(shangpinOrder !=null){
            ...
            if(address != null){
            BeanUtils.copyProperties( address , view ,new String[]{ "id", "createTime", "insertTime", "updateTime", "peisongrenyuanId"
, "yonghuId"});//把级联的数据添加到view中,并排除id和创建时间字段,当前表的级联注册表
            ...
            if(shangpin != null){
            BeanUtils.copyProperties( shangpin , view ,new String[]{ "id", "createTime", "insertTime", "updateTime", "peisongrenyuanId"
, "yonghuId"});//把级联的数据添加到view中,并排除id和创建时间字段,当前表的级联注册表
            ...
            if(yonghu != null){
            BeanUtils.copyProperties( yonghu , view ,new String[]{ "id", "createTime", "insertTime", "updateTime", "peisongrenyuanId"
, "yonghuId"});//把级联的数据添加到view中,并排除id和创建时间字段,当前表的级联注册表
            view.setYonghuId(yonghu.getId());
            }
            //级联表 配送人员
            //级联表
            PeisongrenyuanEntity peisongrenyuan = peisongrenyuanService.selectById(shangpinOrder.getPeisongrenyuanId());
            if(peisongrenyuan != null){
            BeanUtils.copyProperties( peisongrenyuan , view ,new String[]{ "id", "createTime", "insertTime", "updateTime", "peisongrenyuanId"
, "yonghuId"});//把级联的数据添加到view中,并排除id和创建时间字段,当前表的级联注册表
    ...
    */
    ...
    public R save(@RequestBody ShangpinOrderEntity shangpinOrder, HttpServletRequest request){
        ...
        if(false)
            ...
            shangpinOrder.setPeisongrenyuanId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));
        else if("用户".equals(role))
...
//                            shangpinOrderEntity.setPeisongrenyuanId(Integer.valueOf(data.get(0)));   //配送人员 要改的
...
//                            shangpinOrderEntity.setCreateTime(date);//时间
    ...
    */
    ...
    public R add(@RequestBody ShangpinOrderEntity shangpinOrder, HttpServletRequest request){
        logger.debug("add方法:,,Controller:{},,shangpinOrder:{}",this.getClass().getName(),shangpinOrder.toString());
            ...
            shangjia.setNewMoney(shangjia.getNewMoney()+shangpinOrder.getShangpinOrderTruePrice());//动态计算金额
    ...
    public R add(@RequestParam Map<String, Object> params, HttpServletRequest request){
        ...
        for (Map<String, Object> map : shangpins) {
           //取值
            ...
            shangpinOrderEntity.setPeisongrenyuanId(null);
            ...
            shangpinOrderEntity.setCreateTime(new Date());//创建时间  listShow
    ...
    */
    ...
    public R deliver(Integer id ){
        ...
        shangpinOrderEntity.setShangpinOrderTypes(103);//设置订单状态为已备货
    ...
    public R peisong(Integer id , HttpServletRequest request){
        logger.debug("refund:,,Controller:{},,ids:{}",this.getClass().getName(),id.toString());
        ShangpinOrderEntity  shangpinOrderEntity = shangpinOrderService.selectById(id);
        shangpinOrderEntity.setShangpinOrderTypes(106);//设置订单状态为已配送
        shangpinOrderEntity.setPeisongrenyuanId((Integer) request.getSession().getAttribute("userId"));
