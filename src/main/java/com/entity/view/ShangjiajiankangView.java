...
public class ShangjiajiankangView extends ShangjiajiankangEntity implements Serializable {
	...
	*/
	...
	//级联表 商家
		...
		*/
		...
		@ColumnInfo(comment="商家简介",type="text")
	...
	public ShangjiajiankangView() {

	}

	public ShangjiajiankangView(ShangjiajiankangEntity shangjiajiankangEntity) {
		try {
			BeanUtils.copyProperties(this, shangjiajiankangEntity);
