...
public class YonghujiankangView extends YonghujiankangEntity implements Serializable {
	...
	*/
	...
	public YonghujiankangView() {

	}

	public YonghujiankangView(YonghujiankangEntity yonghujiankangEntity) {
		try {
			BeanUtils.copyProperties(this, yonghujiankangEntity);
